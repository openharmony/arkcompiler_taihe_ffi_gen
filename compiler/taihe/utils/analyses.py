...
class AbstractAnalysis(Generic[_H], ABC):
    ...
    @classmethod
    def provide(cls: type[_A], am: "AnalysisManager", arg: _H, instance: _A, /) -> None:
    ...
    @classmethod
    @abstractmethod
    def _create(cls: type[_A], am: "AnalysisManager", arg: _H, /) -> _A:
