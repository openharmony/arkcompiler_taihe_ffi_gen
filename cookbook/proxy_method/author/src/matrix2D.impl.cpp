...
::matrix2D__::Matrix2D identity(::matrix2D__::Matrix2D const& thiz) {
    return ::matrix2D__::Matrix2D{optional<int32_t>::make(2), optional<int32_t>::make(2), optional<int32_t>::make(0), optional<int32_t>::make(0), optional<int32_t>::make(0), optional<int32_t>::make(0)};
}
::matrix2D__::Matrix2D invert(::matrix2D__::Matrix2D const& thiz) {
    if (*thiz.scaleX != 0 || *thiz.scaleY != 0 ) {
        ...
        return ::matrix2D__::Matrix2D{optional<int32_t>::make(scaleX), optional<int32_t>::make(scaleY), optional<int32_t>::make(rotateX), optional<int32_t>::make(rotateY), optional<int32_t>::make(translateX), optional<int32_t>::make(translateY)};
    } else {
        return thiz;
    }
}
::matrix2D__::Matrix2D multiply(::matrix2D__::Matrix2D const& thiz, optional_view<::matrix2D__::Matrix2D> other) {
    if (!other) {
        return thiz;
    }
    ...
    result.translateX = optional<int32_t>::make(*thiz.translateX + *other->translateX);
    result.translateY = optional<int32_t>::make(*thiz.translateY + *other->translateY);
    return result;
}
::matrix2D__::Matrix2D rotate(::matrix2D__::Matrix2D const& thiz, optional_view<int32_t> rx, optional_view<int32_t> ry) {
    if (!rx || !ry) {
        return thiz;
    }
    ::matrix2D__::Matrix2D result = ::matrix2D__::Matrix2D();
...
::matrix2D__::Matrix2D translate(::matrix2D__::Matrix2D const& thiz, optional_view<int32_t> tx, optional_view<int32_t> ty) {
    if (!tx || !ty) {
        return thiz;
    }
    ::matrix2D__::Matrix2D result = ::matrix2D__::Matrix2D();
...
::matrix2D__::Matrix2D scale(::matrix2D__::Matrix2D const& thiz, optional_view<int32_t> sx, optional_view<int32_t> sy) {
    if (!sx || !sy) {
        return thiz;
    }
    ::matrix2D__::Matrix2D result = ::matrix2D__::Matrix2D();
