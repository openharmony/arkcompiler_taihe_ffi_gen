...
::taihe::expected<void, ::taihe::error> interactAnimal(::poly::AnimalType const &a)
{
    switch (a.get_tag()) {
...
::taihe::expected<void, ::taihe::error> introduceYourself(::poly::PersonType const &p)
{
    switch (p.get_tag()) {
        ...
        case ::poly::PersonType::tag_t::worker:
            ...
            std::cout << "I'm a worker, and have worked for " << p.get_worker_ref().service_len << " years"
                      << std::endl;
            break;
