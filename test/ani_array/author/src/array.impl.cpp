...
public:
    ...
    ::taihe::expected<::taihe::array<int8_t>, ::taihe::error> ArrayI8Value(int8_t value)
    {
...
public:
    ...
    ::taihe::expected<::taihe::array<int16_t>, ::taihe::error> ArrayI16Value(int16_t value)
    {
...
public:
    ...
    ::taihe::expected<::taihe::array<int32_t>, ::taihe::error> ArrayI32Value(int32_t value)
    {
...
public:
    ...
    ::taihe::expected<::taihe::array<int64_t>, ::taihe::error> ArrayI64Value(int64_t value)
    {
...
public:
    ...
    ::taihe::expected<::taihe::array<float>, ::taihe::error> ArrayF32Value(float value)
    {
...
public:
    ...
    ::taihe::expected<::taihe::array<double>, ::taihe::error> ArrayF64Value(double value)
    {
...
public:
    ...
    ::taihe::expected<::taihe::array<::taihe::string>, ::taihe::error> ArrayStringValue(::taihe::string_view value)
    {
...
public:
    ...
    ::taihe::expected<::taihe::array<bool>, ::taihe::error> ArrayBoolValue(bool value)
    {
...
public:
    ...
    ::taihe::expected<::taihe::array<::array_test::Color>, ::taihe::error> ArrayEnumValue(::taihe::string_view value)
    {
...
public:
    ...
    ::taihe::expected<::taihe::array<::taihe::map<::taihe::string, int64_t>>, ::taihe::error> ArrayRecordValue(
        ::taihe::string_view valStr, int64_t valLong)
    {
...
public:
    ...
    ::taihe::expected<::taihe::array<::taihe::map<::taihe::string, int8_t>>, ::taihe::error> ArrayRecordValue(
        ::taihe::string_view valStr, int8_t valNum)
    {
...
public:
    ...
    ::taihe::expected<::taihe::array<::taihe::map<::taihe::string, float>>, ::taihe::error> ArrayRecordValue(
        ::taihe::string_view valStr, float valNum)
    {
...
public:
    ...
    ::taihe::expected<::taihe::array<::taihe::map<::taihe::string, double>>, ::taihe::error> ArrayRecordValue(
        ::taihe::string_view valStr, double valNum)
    {
...
public:
    ...
    ::taihe::expected<::taihe::array<::taihe::map<::taihe::string, bool>>, ::taihe::error> ArrayRecordValue(
        ::taihe::string_view valStr, bool valNum)
    {
...
public:
    ...
    ::taihe::expected<::taihe::array<::array_test::UnionA>, ::taihe::error> ArrayValue(::taihe::string_view value)
    {
...
public:
    ...
    ::taihe::expected<::taihe::array<int8_t>, ::taihe::error> fetchDataI8()
    {
...
public:
    ...
    ::taihe::expected<::taihe::array<int16_t>, ::taihe::error> fetchDataI16()
    {
...
public:
    ...
    ::taihe::expected<::taihe::array<int32_t>, ::taihe::error> fetchDataI32()
    {
...
public:
    ...
    ::taihe::expected<::taihe::array<int64_t>, ::taihe::error> fetchDataI64()
    {
...
public:
    ...
    ::taihe::expected<::taihe::array<float>, ::taihe::error> fetchDataF32()
    {
...
public:
    ...
    ::taihe::expected<::taihe::array<double>, ::taihe::error> fetchDataF64()
    {
...
public:
    ...
    ::taihe::expected<::taihe::array<::taihe::string>, ::taihe::error> fetchDataString()
    {
...
public:
    ...
    ::taihe::expected<::taihe::array<bool>, ::taihe::error> fetchDataBool()
    {
...
public:
    ...
    ::taihe::expected<::taihe::array<uint8_t>, ::taihe::error> fetchDataPro()
    {
...
public:
    ...
    ::taihe::expected<::taihe::array<uint16_t>, ::taihe::error> fetchDataPro()
    {
...
public:
    ...
    ::taihe::expected<::taihe::array<::taihe::array<int8_t>>, ::taihe::error> ArrayNestI8(int8_t param)
    {
        ::taihe::array<::taihe::array<int8_t>> res = {{param}, {-128}, {0}, {127}};
        return res;
    }

    ::taihe::expected<::taihe::array<::taihe::array<int16_t>>, ::taihe::error> ArrayNestI16(int16_t param)
    {
        ::taihe::array<::taihe::array<int16_t>> res = {{param}, {-32768}, {0}, {32767}};
        return res;
    }

    ::taihe::expected<::taihe::array<::taihe::array<float>>, ::taihe::error> ArrayNestF32(float param)
    {
        ::taihe::array<::taihe::array<float>> res = {{param}, {-2025.0523}, {0}, {15.58}};
        return res;
    }

    ::taihe::expected<::taihe::array<::taihe::array<::taihe::string>>, ::taihe::error> ArrayNestStrng(
        ::taihe::string_view param)
    {
        ::taihe::array<::taihe::array<string>> res = {{param}, {"nest"}, {"is"}, {"this"}};
        return res;
    }

    ::taihe::expected<::taihe::array<::taihe::array<bool>>, ::taihe::error> ArrayNestBool(bool param)
    {
...
public:
    ...
    ::taihe::expected<::taihe::optional<::taihe::array<::taihe::string>>, ::taihe::error> ArrayOpt(
        ::taihe::string_view name)
    {
...
::taihe::expected<int32_t, ::taihe::error> SumArray(array_view<int32_t> nums, int32_t base)
{
    return std::accumulate(nums.begin(), nums.end(), base);
}

::taihe::expected<int64_t, ::taihe::error> GetArrayValue(array_view<int64_t> nums, int32_t idx)
{
...
::taihe::expected<::taihe::array<::taihe::string>, ::taihe::error> ToStingArray(array_view<int32_t> nums)
{
...
::taihe::expected<::taihe::array<::taihe::map<::taihe::string, int64_t>>, ::taihe::error> MakeRecordArray(
    string_view key, int64_t val, int32_t num)
{
    map<string, int64_t> record;
...
::taihe::expected<::taihe::array<::array_test::Data>, ::taihe::error> MakeStructArray(string_view a, string_view b,
                                                                                      int32_t c, int32_t num)
{
    return array<::array_test::Data>::make(num, ::array_test::Data {a, b, c});
}

::taihe::expected<::taihe::array<::taihe::array<int32_t>>, ::taihe::error> MakeIntArray2(array_view<int32_t> value,
                                                                                         int32_t num)
{
...
::taihe::expected<::taihe::array<::array_test::Data>, ::taihe::error> ChangeStructArray(
    array_view<::array_test::Data> value, string_view a, string_view b, int32_t c)
{
...
::taihe::expected<::taihe::array<float>, ::taihe::error> FetchBinaryDataSync(int32_t num)
{
    if (num <= 0) {
        return ::taihe::unexpected<::taihe::error>(::taihe::error("some error happen in fetchBinaryDataSync", 1));
    } else {
...
::taihe::expected<::taihe::array<::taihe::array<::array_test::Data>>, ::taihe::error> MakeStructArrayArray(
    string_view a, string_view b, int32_t c, int32_t num1, int32_t num2)
{
    auto arr = array<::array_test::Data>::make(num1, ::array_test::Data {a, b, c});
    return array<array<::array_test::Data>>::make(num2, arr);
}

::taihe::expected<::array_test::ArrayI8, ::taihe::error> GetArrayI8()
{
    return taihe::make_holder<ArrayI8Impl, ::array_test::ArrayI8>();
}

::taihe::expected<::array_test::ArrayI16, ::taihe::error> GetArrayI16()
{
    return taihe::make_holder<ArrayI16Impl, ::array_test::ArrayI16>();
}

::taihe::expected<::array_test::ArrayI32, ::taihe::error> GetArrayI32()
{
    return taihe::make_holder<ArrayI32Impl, ::array_test::ArrayI32>();
}

::taihe::expected<::array_test::ArrayI64, ::taihe::error> GetArrayI64()
{
    return taihe::make_holder<ArrayI64Impl, ::array_test::ArrayI64>();
}

::taihe::expected<::array_test::ArrayF32, ::taihe::error> GetArrayF32()
{
    return taihe::make_holder<ArrayF32Impl, ::array_test::ArrayF32>();
}

::taihe::expected<::array_test::ArrayF64, ::taihe::error> GetArrayF64()
{
    return taihe::make_holder<ArrayF64Impl, ::array_test::ArrayF64>();
}

::taihe::expected<::array_test::ArrayString, ::taihe::error> GetArrayString()
{
    return taihe::make_holder<ArrayStringImpl, ::array_test::ArrayString>();
}

::taihe::expected<::array_test::ArrayBool, ::taihe::error> GetArrayBool()
{
    return taihe::make_holder<ArrayBoolImpl, ::array_test::ArrayBool>();
}

::taihe::expected<::array_test::ArrayEnum, ::taihe::error> GetArrayEnum()
{
    return taihe::make_holder<ArrayEnumImpl, ::array_test::ArrayEnum>();
}

::taihe::expected<::array_test::ArrayRecord, ::taihe::error> GetArrayRecord()
{
    return taihe::make_holder<ArrayRecordImpl, ::array_test::ArrayRecord>();
}

::taihe::expected<::array_test::ArrayRecordStrI8, ::taihe::error> GetArrayRecordStrI8()
{
    return taihe::make_holder<ArrayRecordStrI8Impl, ::array_test::ArrayRecordStrI8>();
}

::taihe::expected<::array_test::ArrayRecordStrF32, ::taihe::error> GetArrayRecordStrF32()
{
    return taihe::make_holder<ArrayRecordStrF32Impl, ::array_test::ArrayRecordStrF32>();
}

::taihe::expected<::array_test::ArrayRecordStrF64, ::taihe::error> GetArrayRecordStrF64()
{
    return taihe::make_holder<ArrayRecordStrF64Impl, ::array_test::ArrayRecordStrF64>();
}

::taihe::expected<::array_test::ArrayRecordStrBool, ::taihe::error> GetArrayRecordStrBool()
{
    return taihe::make_holder<ArrayRecordStrBoolImpl, ::array_test::ArrayRecordStrBool>();
}

::taihe::expected<::array_test::ArrayUnion, ::taihe::error> GetArrayUnion()
{
    return taihe::make_holder<ArrayUnionImpl, ::array_test::ArrayUnion>();
}

::taihe::expected<::array_test::ArrayPromiseI8, ::taihe::error> GetArrayPromiseI8()
{
    return taihe::make_holder<ArrayPromiseI8Impl, ::array_test::ArrayPromiseI8>();
}

::taihe::expected<::array_test::ArrayPromiseI16, ::taihe::error> GetArrayPromiseI16()
{
    return taihe::make_holder<ArrayPromiseI16Impl, ::array_test::ArrayPromiseI16>();
}

::taihe::expected<::array_test::ArrayPromiseI32, ::taihe::error> GetArrayPromiseI32()
{
    return taihe::make_holder<ArrayPromiseI32Impl, ::array_test::ArrayPromiseI32>();
}

::taihe::expected<::array_test::ArrayPromiseI64, ::taihe::error> GetArrayPromiseI64()
{
    return taihe::make_holder<ArrayPromiseI64Impl, ::array_test::ArrayPromiseI64>();
}

::taihe::expected<::array_test::ArrayPromiseF32, ::taihe::error> GetArrayPromiseF32()
{
    return taihe::make_holder<ArrayPromiseF32Impl, ::array_test::ArrayPromiseF32>();
}

::taihe::expected<::array_test::ArrayPromiseF64, ::taihe::error> GetArrayPromiseF64()
{
    return taihe::make_holder<ArrayPromiseF64Impl, ::array_test::ArrayPromiseF64>();
}

::taihe::expected<::array_test::ArrayPromiseString, ::taihe::error> GetArrayPromiseString()
{
    return taihe::make_holder<ArrayPromiseStringImpl, ::array_test::ArrayPromiseString>();
}

::taihe::expected<::array_test::ArrayPromiseBool, ::taihe::error> GetArrayPromiseBool()
{
    return taihe::make_holder<ArrayPromiseBoolImpl, ::array_test::ArrayPromiseBool>();
}

::taihe::expected<::array_test::ArrayPromiseU8, ::taihe::error> GetArrayPromiseU8()
{
    return taihe::make_holder<ArrayPromiseU8Impl, ::array_test::ArrayPromiseU8>();
}

::taihe::expected<::array_test::ArrayPromiseU16, ::taihe::error> GetArrayPromiseU16()
{
    return taihe::make_holder<ArrayPromiseU16Impl, ::array_test::ArrayPromiseU16>();
}

::taihe::expected<::array_test::ArrayNest, ::taihe::error> GetArrayNest()
{
    return taihe::make_holder<ArrayNestImpl, ::array_test::ArrayNest>();
}

::taihe::expected<::array_test::ArrayOptional, ::taihe::error> GetArrayOptional()
{
