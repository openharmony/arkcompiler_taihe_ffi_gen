...
public:
  ...
  ::taihe::array<::array_test::Color> ArrayEnumValue(
      ::taihe::string_view value) {
    ::taihe::array<::array_test::Color> color = {
        ::array_test::Color::key_t::RED, ::array_test::Color::key_t::GREEN,
...
public:
  ...
  ::taihe::array<::taihe::map<::taihe::string, int64_t>> ArrayRecordValue(
      ::taihe::string_view valStr, int64_t valLong) {
    map<string, int64_t> record;
    record.emplace(valStr, valLong);
    ::taihe::array<::taihe::map<::taihe::string, int64_t>> res = {
...
public:
  ...
  ::taihe::array<::taihe::map<::taihe::string, int8_t>> ArrayRecordValue(
      ::taihe::string_view valStr, int8_t valNum) {
    map<string, int8_t> record;
    record.emplace(valStr, valNum);
    ::taihe::array<::taihe::map<::taihe::string, int8_t>> res = {record, record,
                                                                 record};
    return res;
  }
};
...
public:
  ...
  ::taihe::array<::taihe::map<::taihe::string, float>> ArrayRecordValue(
      ::taihe::string_view valStr, float valNum) {
    map<string, float> record;
    record.emplace(valStr, valNum);
    ::taihe::array<::taihe::map<::taihe::string, float>> res = {record, record,
                                                                record};
    return res;
  }
};
...
public:
  ...
  ::taihe::array<::taihe::map<::taihe::string, double>> ArrayRecordValue(
      ::taihe::string_view valStr, double valNum) {
    map<string, double> record;
    record.emplace(valStr, valNum);
    ::taihe::array<::taihe::map<::taihe::string, double>> res = {record, record,
                                                                 record};
    return res;
  }
};
...
public:
  ...
  ::taihe::array<::taihe::map<::taihe::string, bool>> ArrayRecordValue(
      ::taihe::string_view valStr, bool valNum) {
    map<string, bool> record;
    record.emplace(valStr, valNum);
    ::taihe::array<::taihe::map<::taihe::string, bool>> res = {record, record,
                                                               record};
    return res;
  }
};
...
public:
  ...
  ::taihe::array<int64_t> fetchDataI64() {
    ::taihe::array<int64_t> res = {-9223372036854775807, 0,
                                   9223372036854775807};
    return res;
  }
};
...
public:
  ...
  ::taihe::array<::taihe::array<int16_t>> ArrayNestI16(int16_t param) {
    ::taihe::array<::taihe::array<int16_t>> res = {
        {param}, {-32768}, {0}, {32767}};
    return res;
  }

  ::taihe::array<::taihe::array<float>> ArrayNestF32(float param) {
    ::taihe::array<::taihe::array<float>> res = {
        {param}, {-2025.0523}, {0}, {15.58}};
    return res;
  }

  ::taihe::array<::taihe::array<::taihe::string>> ArrayNestStrng(
      ::taihe::string_view param) {
    ::taihe::array<::taihe::array<string>> res = {
        {param}, {"nest"}, {"is"}, {"this"}};
    return res;
  }
...
public:
  ...
  ::taihe::optional<::taihe::array<::taihe::string>> ArrayOpt(
      ::taihe::string_view name) {
    optional<array<::taihe::string>> res =
        optional<array<::taihe::string>>::make(
            array<::taihe::string>{name, name, name});
    return res;
  }
};
...
::array_test::ArrayRecordStrI8 GetArrayRecordStrI8() {
  return taihe::make_holder<ArrayRecordStrI8Impl,
                            ::array_test::ArrayRecordStrI8>();
}

::array_test::ArrayRecordStrF32 GetArrayRecordStrF32() {
  return taihe::make_holder<ArrayRecordStrF32Impl,
                            ::array_test::ArrayRecordStrF32>();
}

::array_test::ArrayRecordStrF64 GetArrayRecordStrF64() {
  return taihe::make_holder<ArrayRecordStrF64Impl,
                            ::array_test::ArrayRecordStrF64>();
}

::array_test::ArrayRecordStrBool GetArrayRecordStrBool() {
  return taihe::make_holder<ArrayRecordStrBoolImpl,
                            ::array_test::ArrayRecordStrBool>();
}
...
::array_test::ArrayPromiseI16 GetArrayPromiseI16() {
  return taihe::make_holder<ArrayPromiseI16Impl,
                            ::array_test::ArrayPromiseI16>();
}

::array_test::ArrayPromiseI32 GetArrayPromiseI32() {
  return taihe::make_holder<ArrayPromiseI32Impl,
                            ::array_test::ArrayPromiseI32>();
}

::array_test::ArrayPromiseI64 GetArrayPromiseI64() {
  return taihe::make_holder<ArrayPromiseI64Impl,
                            ::array_test::ArrayPromiseI64>();
}

::array_test::ArrayPromiseF32 GetArrayPromiseF32() {
  return taihe::make_holder<ArrayPromiseF32Impl,
                            ::array_test::ArrayPromiseF32>();
}

::array_test::ArrayPromiseF64 GetArrayPromiseF64() {
  return taihe::make_holder<ArrayPromiseF64Impl,
                            ::array_test::ArrayPromiseF64>();
}

::array_test::ArrayPromiseString GetArrayPromiseString() {
  return taihe::make_holder<ArrayPromiseStringImpl,
                            ::array_test::ArrayPromiseString>();
}

::array_test::ArrayPromiseBool GetArrayPromiseBool() {
  return taihe::make_holder<ArrayPromiseBoolImpl,
                            ::array_test::ArrayPromiseBool>();
}
...
::array_test::ArrayPromiseU16 GetArrayPromiseU16() {
  return taihe::make_holder<ArrayPromiseU16Impl,
                            ::array_test::ArrayPromiseU16>();
}
