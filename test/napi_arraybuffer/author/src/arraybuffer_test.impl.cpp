...
namespace {
::taihe::expected<uint32_t, ::taihe::error> SumArrayU8(::taihe::array_view<uint8_t> nums)
{
    return std::accumulate(nums.begin(), nums.end(), 0);
}

::taihe::expected<::taihe::array<uint8_t>, ::taihe::error> GetArrayBuffer(uint32_t nums)
{
