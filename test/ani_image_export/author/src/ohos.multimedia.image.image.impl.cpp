...
public:
    ...
    ImageInfo getImageInfoSync() {
        ...
        return {{imgInfo.size.width, imgInfo.size.height}, imgInfo.baseDensity, imgInfo.size.height,
        toPixelMapFormatKey(imgInfo.pixelFormat), toAlphaTypeKey(imgInfo.alphaType), imgInfo.encodedFormat, this->m_pdata->IsHdr()};
    }
...
public:
    ...
    ImageInfo getImageInfoSync(int32_t index) {
        OHOS::Media::ImageInfo imgInfo;
        return {{imgInfo.size.width, imgInfo.size.height}, imgInfo.baseDensity, imgInfo.size.height,
        toPixelMapFormatKey(imgInfo.pixelFormat), toAlphaTypeKey(imgInfo.alphaType), imgInfo.encodedFormat, false};
    }
