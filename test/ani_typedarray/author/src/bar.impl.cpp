...
public:
  ...
  void CreateUint8Array(::taihe::array_view<uint8_t> a) {
    this->uint8Arr = a;
    std::cout << "createUint8Array uint8Arr length: " << this->uint8Arr.size()
              << std::endl;
  ...
  void SetUint8Array(::taihe::array_view<uint8_t> a) {
    this->uint8Arr = a;
    std::cout << "setUint8Array uint8Arr length: " << this->uint8Arr.size()
              << std::endl;
  ...
  void CreateInt8Array(::taihe::array_view<int8_t> a) {
    this->int8Arr = a;
    std::cout << "createInt8Array int8Arr length: " << this->int8Arr.size()
              << std::endl;
  ...
  void SetInt8Array(::taihe::array_view<int8_t> a) {
    this->int8Arr = a;
    std::cout << "setInt8Array int8Arr length: " << this->int8Arr.size()
              << std::endl;
  ...
  void CreateUint16Array(::taihe::array_view<uint16_t> a) {
    this->uint16Arr = a;
    std::cout << "createUint16Array uint16Arr length: "
              << this->uint16Arr.size() << std::endl;
  ...
  void SetUint16Array(::taihe::array_view<uint16_t> a) {
    this->uint16Arr = a;
    std::cout << "setUint16Array uint16Arr length: " << this->uint16Arr.size()
              << std::endl;
  ...
  void CreateInt16Array(::taihe::array_view<int16_t> a) {
    this->int16Arr = a;
    std::cout << "createInt16Array int16Arr length: " << this->int16Arr.size()
              << std::endl;
  ...
  void SetInt16Array(::taihe::array_view<int16_t> a) {
    this->int16Arr = a;
    std::cout << "setInt16Array int16Arr length: " << this->int16Arr.size()
              << std::endl;
  ...
  void CreateUint32Array(::taihe::array_view<uint32_t> a) {
    this->uint32Arr = a;
    std::cout << "createUint32Array uint32Arr length: "
              << this->uint32Arr.size() << std::endl;
  ...
  void SetUint32Array(::taihe::array_view<uint32_t> a) {
    this->uint32Arr = a;
    std::cout << "setUint32Array uint32Arr length: " << this->uint32Arr.size()
              << std::endl;
  ...
  void CreateInt32Array(::taihe::array_view<int32_t> a) {
    this->int32Arr = a;
    std::cout << "createInt32Array int32Arr length: " << this->int32Arr.size()
              << std::endl;
  ...
  void SetInt32Array(::taihe::array_view<int32_t> a) {
    this->int32Arr = a;
    std::cout << "setInt32Array int32Arr length: " << this->int32Arr.size()
              << std::endl;
  ...
  void CreateUint64Array(::taihe::array_view<uint64_t> a) {
    this->uint64Arr = a;
    std::cout << "createUint64Array uint64Arr length: "
              << this->uint64Arr.size() << std::endl;
  ...
  void SetUint64Array(::taihe::array_view<uint64_t> a) {
    this->uint64Arr = a;
    std::cout << "setUint64Array uint64Arr length: " << this->uint64Arr.size()
              << std::endl;
  ...
  void CreateInt64Array(::taihe::array_view<int64_t> a) {
    this->int64Arr = a;
    std::cout << "createInt64Array int64Arr length: " << this->int64Arr.size()
              << std::endl;
  ...
  void SetInt64Array(::taihe::array_view<int64_t> a) {
    this->int64Arr = a;
    std::cout << "setInt64Array int64Arr length: " << this->int64Arr.size()
              << std::endl;
  ...
  void CreateFloat32Array(::taihe::array_view<float> a) {
    this->float32Arr = a;
    std::cout << "createFloat32Array float32Arr length: "
              << this->float32Arr.size() << std::endl;
  ...
  void SetFloat32Array(::taihe::array_view<float> a) {
    this->float32Arr = a;
    std::cout << "setFloat32Array float32Arr length: "
              << this->float32Arr.size() << std::endl;
  ...
  void CreateFloat64Array(::taihe::array_view<double> a) {
    this->float64Arr = a;
    std::cout << "createFloat64Array float64Arr length: "
              << this->float64Arr.size() << std::endl;
  ...
  void SetFloat64Array(::taihe::array_view<double> a) {
    this->float64Arr = a;
    std::cout << "setFloat64Array float64Arr length: "
              << this->float64Arr.size() << std::endl;
  ...
  ::taihe::array<int64_t> ConvertToInt64Array(::taihe::array_view<uint8_t> a,
    ...
    for (size_t i = 0; i < this->uint8Arr.size(); ++i) {
      result[i] = static_cast<int64_t>(this->uint8Arr[i]) +
                  static_cast<int64_t>(this->uint16Arr[i]) +
                  static_cast<int64_t>(this->uint32Arr[i]) +
                  static_cast<int64_t>(this->uint64Arr[i]) +
                  static_cast<int64_t>(this->int8Arr[i]);
    }
    return result;
  }

  ::taihe::array<double> ConvertToFloat64Array(::taihe::array_view<int16_t> a,
    ...
    for (size_t i = 0; i < this->int16Arr.size(); ++i) {
      result[i] = static_cast<double>(this->int16Arr[i]) +
                  static_cast<double>(this->int32Arr[i]) +
                  static_cast<double>(this->int64Arr[i]) +
                  static_cast<double>(this->float32Arr[i]) +
                  this->float64Arr[i];
    }
    return result;
  }

  ::taihe::array<int32_t> GetUint8ArrayOptional(
  ...
  ::taihe::array<int32_t> GetInt8ArrayOptional(
  ...
  ::taihe::array<int32_t> GetUint16ArrayOptional(
  ...
  ::taihe::array<int32_t> GetInt16ArrayOptional(
  ...
  ::taihe::array<int32_t> GetUint32ArrayOptional(
  ...
  ::taihe::array<int32_t> GetInt32ArrayOptional(
  ...
  ::taihe::array<int32_t> GetUint64ArrayOptional(
  ...
  ::taihe::array<int32_t> GetInt64ArrayOptional(
  ...
  ::taihe::array<int32_t> GetFloat32ArrayOptional(
  ...
  ::taihe::array<int32_t> GetFloat64ArrayOptional(
