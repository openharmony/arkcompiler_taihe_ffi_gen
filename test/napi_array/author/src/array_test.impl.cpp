...
::taihe::array<::array_test::Color> makeEnumArray(::array_test::Color value,
                                                  int32_t num) {
  return ::taihe::array<::array_test::Color>::make(num, value);
}

::taihe::array<::array_test::Data> makeStructArray(::taihe::string_view a,
                                                   ::taihe::string_view b,
                                                   int32_t c, int32_t num) {
  return ::taihe::array<::array_test::Data>::make(num,
                                                  ::array_test::Data{a, b, c});
}

::taihe::array<::array_test::Color> changeEnumArray(
    ::taihe::array_view<::array_test::Color> value, ::array_test::Color color) {
  auto result =
      ::taihe::array<::array_test::Color>::make(value.size(), value[0]);
...
::taihe::array<::array_test::Data> changeStructArray(
    ::taihe::array_view<::array_test::Data> value, ::taihe::string_view a,
    ::taihe::string_view b, int32_t c) {
  auto result =
      ::taihe::array<::array_test::Data>::make(value.size(), value[0]);
  std::transform(value.begin(), value.end(), result.begin(),
...
::taihe::array<::taihe::array<::array_test::Data>> makeStructArrayArray(
    ::taihe::string_view a, ::taihe::string_view b, int32_t c, int32_t num1,
    int32_t num2) {
  auto arr = ::taihe::array<::array_test::Data>::make(
      num1, ::array_test::Data{a, b, c});
...
::taihe::array<::array_test::IBase> changeIfaceArray(
