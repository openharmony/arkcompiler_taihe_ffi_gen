...
class PrimitivesInteger {
 public:
  ...
  int8_t getI8testattribute() { return INT8_MAX; }
  int16_t getI16testattribute() { return INT16_MIN; }
  int32_t getI32testattribute() { return INT32_MAX; }
  int64_t getI64testattribute() { return INT64_MAX; }
  float getf32testattribute() { return 3.14; }
  double getf64testattribute() { return 123.45678; }
};
...
float BaseFunc1(float b) { return b + 1.0; }
...
double BaseFunc3(float a, double b) { return static_cast<double>(a) + b; }

double BaseFunc4(double b) { return b + 1.0; }
...
void BaseFunc10() { std::cout << "BaseFunc10 is true " << std::endl; }
...
bool TestBaseBoolFunc6() { return false; }
