...
::taihe::map<::taihe::string, ::taihe::string> deserializeMap(
...
::taihe::array<::test::Pair> serializeMap(
    ::taihe::map_view<::taihe::string, ::taihe::string> m) {
  auto arr = taihe::array<::test::Pair>(
      taihe::copy_data,
...
::taihe::set<::taihe::string> deserializeSet(
...
::taihe::array<::taihe::string> serializeSet(
    ::taihe::set_view<::taihe::string> s) {
  return taihe::array<::taihe::string>(
      taihe::copy_data,
...
::taihe::vector<::taihe::string> deserializeVector(
    ::taihe::array_view<::taihe::string> serialized) {
...
::taihe::array<::taihe::string> serializeVector(
