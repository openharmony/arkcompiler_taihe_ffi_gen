...
::union_ani::BasicUnion MakeAndShowBasicUnion(
    ::union_ani::BasicUnion const &data) {
  switch (data.get_tag()) {
...
::union_ani::TypedArrayUnion MakeAndShowTypedArrayUnion(
...
::union_ani::ArrayUnion MakeAndShowArrayUnion(
    ::union_ani::ArrayUnion const &data) {
  switch (data.get_tag()) {
...
::union_ani::StructUnion MakeAndShowStructUnion(
    ::union_ani::StructUnion const &data) {
  switch (data.get_tag()) {
