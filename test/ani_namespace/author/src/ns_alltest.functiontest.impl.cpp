...
class TestNameSpace {
 ...
 public:
  ...
  double BaseFunctionTest49(double param1) { return param1 - testInt_add100_; }
  ...
  map<int16_t, ::ns_alltest::functiontest::Data> BaseFunctionTest55(
    ...
    for (const auto& [key, value] : param1) {
      m.emplace(key, value);
    }
    return m;
  }
  ...
  ::ns_alltest::functiontest::ErrorResponse BaseFunctionTest58(bool param1) {
    if (param1) {
      ...
      return {false, static_cast<int16_t>(testInt_add100_),
              std::string("test581")};
    }
  }
};
...
class TestInterfacePerformance21 {
 public:
  ...
  int32_t geti32_test() { return INT32_MAX; }
  ...
  int8_t geti8_test_attribute() { return INT8_MAX; }
  int16_t geti16_test_attribute() { return INT16_MAX; }
  int32_t geti32_test_attribute() { return INT32_MAX; }
  int64_t geti64_test_attribute() { return INT64_MAX; }
  float getf32_test_attribute() { return 3.14; }
  double getf64_test_attribute() { return -1.23; }
  string getStr_test_attribute() { return "TESTSTR"; }
  bool getbool_test_attribute() { return false; }
  ...
  array<bool> getArray_test_attribute() { return array<bool>::make(1, true); }
...
class IbaseInterface1 {
 public:
  ...
  int32_t BaseTest() { return INT32_MIN; }
};
class IbaseInterface2 {
 public:
  ...
  string BaseTest1() { return "TestInterface"; }
  int32_t BaseTest() { return INT32_MIN; }
};
class IbaseInterface3 {
 public:
  ...
  bool BaseTest2() { return true; }
  int32_t BaseTest() { return INT32_MAX; }
};
...
float BaseFunctionTest20(float param1) { return param1 + testInt_add100_; }
...
::ns_alltest::functiontest::Color BaseFunctionTest30(
  ...
  return (::ns_alltest::functiontest::Color::key_t)(
      ((int)param1.get_key() + 1) % testEnum_);
}
