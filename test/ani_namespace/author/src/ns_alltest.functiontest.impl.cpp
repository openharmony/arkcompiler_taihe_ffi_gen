...
int16_t baseFunctionTest17(int16_t param1) {
    ...
    if (result > INT16_MAX || result < INT16_MIN) {
       taihe::core::throw_error("baseFunctionTest17: result exceeds int16_t range");
    }
    // 返回结果
...
int32_t baseFunctionTest18(int32_t param1) {
    ...
    if (result > INT32_MAX || result < INT32_MIN) {
       taihe::core::throw_error("baseFunctionTest18: result exceeds int32_t range");
    }
    // 返回结果
...
int64_t baseFunctionTest19(int64_t param1) {
    ...
    if (result > INT64_MAX || result < INT64_MIN) {
       taihe::core::throw_error("baseFunctionTest19: result exceeds int64_t range");
    }
    // 返回结果
...
optional<int16_t> baseFunctionTest26(optional_view<int16_t> param1) {
    if (param1) {
        ...
        std::cout << "NameSpaceImpl: " <<  __func__ << " result " << result << std::endl; 
        if (result > INT16_MAX || result < INT16_MIN) {
        taihe::core::throw_error("baseFunctionTest26: result exceeds int16_t range");
        }
        // 返回结果
...
optional<int64_t> baseFunctionTest27(optional_view<int64_t> param1) {
    if (param1) {
        ...
        int64_t result = *param1+10; 
        if (result > INT64_MAX || result < INT64_MIN) {
        taihe::core::throw_error("baseFunctionTest27: result exceeds int16_t range");
        }
        // 返回结果
...
int16_t baseFunctionTest32(int8_t param1, int16_t param2, int32_t param3, int64_t param4, float param5, double param6, string_view param7, bool param8, array_view<int16_t> param9, array_view<int64_t> param10) {
    if (param8) {
        return param2;
    } else {
...
int32_t baseFunctionTest33(int8_t param1, int16_t param2, int32_t param3, int64_t param4, float param5, double param6, string_view param7, bool param8, array_view<int8_t> param9, array_view<int32_t> param10) {
    if (param8) {
        return param3;
    } else {
...
int64_t baseFunctionTest34(int8_t param1, int16_t param2, int32_t param3, int64_t param4, float param5, double param6, string_view param7, bool param8, array_view<string> param9, array_view<int64_t> param10) {
    if (param8) {
        return param4;
    } else {
...
int8_t baseFunctionTest35(int8_t param1, int16_t param2, int32_t param3, int64_t param4, float param5, double param6, string_view param7, bool param8, array_view<bool> param9, array_view<int64_t> param10) {
    if (param8) {
...
array<int32_t> baseFunctionTest36(int8_t param1, int16_t param2, int32_t param3, int64_t param4, float param5, double param6, string_view param7, bool param8, array_view<int8_t> param9, array_view<int64_t> param10) {
    if (param8) {
...
array<int64_t> baseFunctionTest37(int8_t param1, int16_t param2, int32_t param3, int64_t param4, float param5, double param6, string_view param7, bool param8, array_view<int32_t> param9, array_view<int64_t> param10) {
    if (param8) {
...
string baseFunctionTest38(int8_t param1, int16_t param2, int32_t param3, int64_t param4, float param5, double param6, string_view param7, bool param8, array_view<int8_t> param9, array_view<int16_t> param10) {
    if(param8){
        return std::string(param7) + std::to_string(param1) + std::to_string(param2) + std::to_string(param3) + std::to_string(param4);
    } else {
        return std::string(param7) + std::to_string(param9[0]) + std::to_string(param10[0]);
    }
}
bool baseFunctionTest39(int8_t param1, int16_t param2, int32_t param3, int64_t param4, float param5, double param6, string_view param7, bool param8, array_view<bool> param9, array_view<int32_t> param10) {
    if(param2 == 100){
        return param8;
    } else {
        return false;
...
array<int8_t> baseFunctionTest40(int8_t param1, int16_t param2, int32_t param3, int64_t param4, float param5, double param6, string_view param7, bool param8, array_view<int8_t> param9, array_view<uint8_t> param10) {
    if(param8){
...
void baseFunctionTest41(int8_t param1, int16_t param2, int32_t param3, int64_t param4, float param5, double param6, string_view param7, bool param8, array_view<int16_t> param9, array_view<int64_t> param10) {
    std::cout << "NameSpaceImpl: " <<  __func__ << " param1 " << param1 << " param2 " << param2 << " param3 " << param3 << " param4 " << param4 << std::endl;
}
int32_t baseFunctionTest42_int(int32_t param1, int16_t param2) {
    ...
    std::cout << "NameSpaceImpl: " <<  __func__ << " result " << result << std::endl; 
    if (result > INT32_MAX || result < INT32_MIN) {
       taihe::core::throw_error("baseFunctionTest42_int: result exceeds int32_t range");
    }
    // 返回结果
    return static_cast<int32_t>(result);
}
