...
public:
    ...
    ::taihe::expected<::taihe::string, ::taihe::error> testCbIntString(::taihe::callback_view<void(int32_t, int32_t)> f)
    {
        f(ten, hundred);
        return "testCbIntString";
    }

    ::taihe::expected<bool, ::taihe::error> testCbIntBool(::taihe::callback_view<void(int32_t, int32_t)> f)
    {
        f(hundred, hundred);
        return true;
    }
    ...
    ::taihe::expected<::cb_test::EnumData, ::taihe::error> testCbEnum(
        ::taihe::callback_view<::cb_test::EnumData(::cb_test::EnumData)> f)
    {
...
::taihe::expected<::taihe::string, ::taihe::error> test_cb_iface(
    ::taihe::callback_view<::cb_test::MyInterface(::cb_test::weak::MyInterface a)> f)
{
